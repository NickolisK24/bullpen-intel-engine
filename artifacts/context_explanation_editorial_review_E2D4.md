# Context Explanation Editorial Review Corpus - E2D-4 Healthy-State Team Context Voice Migration
...
```json
{
  "artifact": "artifacts/context_explanation_editorial_review_E2D4.md",
  ...
  "example_count": 42,
  "generated_at": "2026-06-30T02:54:54.017556",
...
```
Limited Read
There is not enough recent workload data to read late-inning availability yet. This is a data-limited note, not a statement about injury status or manager intent.
...
```json
{
  "reads": [
    {
      "explanation": "There is not enough recent workload data to read late-inning availability yet. This is a data-limited note, not a statement about injury status or manager intent.",
...
Limited Coverage Safety
The bullpen has no rested length option and no additional length option on monitor. one length option is carrying enough recent workload to limit coverage.
Thin Depth Safety
...
```json
{
  "reads": [
    ...
    {
      "explanation": "The bullpen has no rested length option and no additional length option on monitor. one length option is carrying enough recent workload to limit coverage.",
      "key": "coverageSafety",

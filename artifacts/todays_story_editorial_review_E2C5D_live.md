# Today's Story Editorial Review Corpus - E2C-5D Live
...
```json
{
  "artifact": "artifacts/todays_story_editorial_review_E2C5D_live.md",
  ...
  "generated_at": "2026-06-30T00:58:25.731905",
...
{
  "headline_counts": {
    "Bullpen finished the lead": 4,
    "Bullpen note: Bullpen finished the lead": 2,
    "Bullpen note: Late innings stayed quiet": 4,
    "Bullpen note: Late lead held": 1,
    "Bullpen note: Late lead slipped away": 1,
    "Bullpen note: Lead disappeared late": 2,
    "Bullpen note: Lead finished cleanly": 1,
    "Bullpen note: Lead protected": 2,
    "Bullpen note: Relievers left room for the rally": 2,
    "Bullpen stretched thin": 6,
    "Late innings stayed quiet": 8,
    "Late lead held": 2,
    "Late lead slipped away": 2,
    "Lead disappeared late": 4,
    "Lead finished cleanly": 2,
    "Lead protected": 4,
    "Relievers left room for the rally": 4,
    "Short start stretched the bullpen": 6,
    "Starter carried the load": 2,
    "Starter spared the bullpen": 6
  },
  "max_reuse_count": 8,
  "reused_headlines": {
    "Bullpen finished the lead": 4,
...
```json
{
  "beat_summaries": {
    ...
    "protected_game_shape": {
      "duplicate_template_count": 2,
      "story_count": 10,
      "unique_template_count": 9
    },
  ...
  "duplicate_groups": [
    {
      ...
      "template_key": "name their most recent game, name worked six innings and left with a five-run lead, and the bullpen brought it home."
    },
    {
      ...
      "template_key": "name their most recent game, name worked num innings, so the bullpen only had to finish the shorter piece. name lets the bullpen spread the work across more arms."
    }
  ],
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "HIGH",
      "game_pk": 824256,
      "generated_at": "2026-06-30T00:58:21.167850",
...
Headline:
```
Bullpen note: Lead disappeared late
```
Body:
```
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "HIGH",
      "game_pk": 824011,
      "generated_at": "2026-06-30T00:58:23.000340",
...
Body:
```
After their most recent game, Sam Aldegheri handed off after five innings with a four-run lead, and the bullpen finished it. That keeps the workload from spreading across the full bullpen.
```
What BaseballOS noticed / observations:
```
- The starter set the bullpen up to finish the game.
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 822959,
      "generated_at": "2026-06-30T00:58:23.071035",
...
Body:
```
After their most recent game, Merrill Kelly worked 6.0 innings, keeping the bullpen out of the heaviest innings. That lets the bullpen spread the work across more arms.
```
What BaseballOS noticed / observations:
```
(none)
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 824821,
      "generated_at": "2026-06-30T00:58:23.136644",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 824744,
      "generated_at": "2026-06-30T00:58:23.207167",
...
Body:
```
After their most recent game, Sonny Gray handed off after 7.1 innings with a two-run lead, and the bullpen finished it.
```
What BaseballOS noticed / observations:
```
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 823769,
      "generated_at": "2026-06-30T00:58:23.298617",
      "headline_key": "bullpen_overexposed",
      "primary_story": "bullpen_overexposed",
      "secondary_story": "bullpen_kept_team_alive",
      "story_priority": "MEDIUM",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 823362,
      "generated_at": "2026-06-30T00:58:23.465545",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 824422,
      "generated_at": "2026-06-30T00:58:23.535422",
...
Body:
```
After their most recent game, Gavin Williams's five innings left a two-run deficit to erase, but the bullpen kept it from growing. The offense finished the rally.
```
What BaseballOS noticed / observations:
```
- The starter set the bullpen up to finish the game.
...
Headline:
```
Bullpen note: Relievers left room for the rally
```
Body:
```
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 823686,
      "generated_at": "2026-06-30T00:58:23.599865",
      "headline_key": "starter_carried_game",
      "primary_story": "starter_covered_bullpen",
      "secondary_story": null,
      "story_priority": "MEDIUM",
...
Body:
```
After their most recent game, Ryan Feltner worked 6.0 innings, so the bullpen only had to finish the shorter piece. That lets the bullpen spread the work across more arms.
```
What BaseballOS noticed / observations:
```
(none)
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "HIGH",
      "game_pk": 824256,
      "generated_at": "2026-06-30T00:58:23.693268",
      "headline_key": "lost_game_shape",
      "primary_story": "lost_game_shape",
      "secondary_story": "late_pressure_accumulated",
      "story_priority": "CRITICAL",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 824256,
      "generated_at": "2026-06-30T00:58:23.766721",
      "headline_key": "insufficient_context",
      "primary_story": "insufficient_context",
      "secondary_story": null,
      "story_priority": "LOW",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 824580,
      "generated_at": "2026-06-30T00:58:23.841010",
      "headline_key": "bullpen_overexposed",
      "primary_story": "bullpen_overexposed",
      "secondary_story": "bullpen_kept_team_alive",
      "story_priority": "MEDIUM",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 823281,
      "generated_at": "2026-06-30T00:58:23.944195",
      "headline_key": "bullpen_stabilized",
      "primary_story": "protected_game_shape",
      "secondary_story": null,
      "story_priority": "HIGH",
...
Body:
```
After their most recent game, Emmet Sheehan worked five innings and left with a three-run lead, and the bullpen brought it home. That keeps the work gathered on a smaller group.
```
What BaseballOS noticed / observations:
```
- The starter set the bullpen up to finish the game.
...
Headline:
```
Bullpen note: Late innings stayed quiet
```
Body:
```
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "HIGH",
      "game_pk": 824821,
      "generated_at": "2026-06-30T00:58:24.018293",
      "headline_key": "protected_game_shape",
      "primary_story": "protected_game_shape",
      "secondary_story": "bullpen_kept_team_alive",
      "story_priority": "HIGH",
...
Body:
```
After their most recent game, Zack Littell handed off after five innings with a four-run lead, and the bullpen finished it.
```
What BaseballOS noticed / observations:
```
- The starter set the bullpen up to finish the game.
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 823608,
      "generated_at": "2026-06-30T00:58:24.142325",
      "headline_key": "bullpen_overexposed",
      "primary_story": "bullpen_overexposed",
      "secondary_story": "late_pressure_accumulated",
      "story_priority": "MEDIUM",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 824011,
      "generated_at": "2026-06-30T00:58:24.380748",
      "headline_key": "insufficient_context",
      "primary_story": "insufficient_context",
      "secondary_story": null,
      "story_priority": "LOW",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "HIGH",
      "game_pk": 823362,
      "generated_at": "2026-06-30T00:58:24.450511",
      "headline_key": "bullpen_stabilized",
      "primary_story": "protected_game_shape",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 823281,
      "generated_at": "2026-06-30T00:58:24.526569",
      "headline_key": "bullpen_overexposed",
      "primary_story": "bullpen_overexposed",
      "secondary_story": null,
      "story_priority": "MEDIUM",
...
Body:
```
After their most recent game, Michael King's 4.1-inning start left the bullpen to cover the rest.
```
What BaseballOS noticed / observations:
```
(none)
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 824422,
      "generated_at": "2026-06-30T00:58:24.595034",
      "headline_key": "lost_game_shape",
      "primary_story": "lost_game_shape",
      "secondary_story": "late_pressure_accumulated",
      "story_priority": "CRITICAL",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 823204,
      "generated_at": "2026-06-30T00:58:24.667613",
      "headline_key": "protected_game_shape",
      "primary_story": "protected_game_shape",
      "secondary_story": "late_pressure_accumulated",
      "story_priority": "HIGH",
...
Body:
```
After their most recent game, Robbie Ray handed off after eight innings with a three-run lead, and the bullpen finished it.
```
What BaseballOS noticed / observations:
```
- The starter went deep and set the bullpen up to finish the game.
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 823037,
      "generated_at": "2026-06-30T00:58:24.768891",
      "headline_key": "bullpen_stabilized",
      "primary_story": "protected_game_shape",
      "secondary_story": null,
      "story_priority": "HIGH",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "HIGH",
      "game_pk": 822959,
      "generated_at": "2026-06-30T00:58:24.835901",
      "headline_key": "protected_game_shape",
      "primary_story": "protected_game_shape",
      "secondary_story": null,
      "story_priority": "HIGH",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 822795,
      "generated_at": "2026-06-30T00:58:24.905278",
      "headline_key": "protected_game_shape",
      "primary_story": "protected_game_shape",
      "secondary_story": "late_pressure_accumulated",
      "story_priority": "HIGH",
...
Body:
```
After their most recent game, Kumar Rocker handed off after six innings with a two-run lead, and the bullpen finished it.
```
What BaseballOS noticed / observations:
```
- The starter went deep and set the bullpen up to finish the game.
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 822795,
      "generated_at": "2026-06-30T00:58:24.972802",
      "headline_key": "insufficient_context",
      "primary_story": "insufficient_context",
      "secondary_story": null,
      "story_priority": "LOW",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 823686,
      "generated_at": "2026-06-30T00:58:25.053027",
      "headline_key": "bullpen_kept_team_alive",
      "primary_story": "bullpen_kept_team_alive",
      "secondary_story": "starter_covered_bullpen",
      "story_priority": "HIGH",
...
Body:
```
After their most recent game, Connor Prielipp's six innings left a one-run deficit to erase, but the bullpen kept it from growing. The offense finished the rally.
```
What BaseballOS noticed / observations:
```
- The starter went deep and set the bullpen up to finish the game.
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 823608,
      "generated_at": "2026-06-30T00:58:25.220199",
      "headline_key": "bullpen_stabilized",
      "primary_story": "protected_game_shape",
      "secondary_story": "bullpen_kept_team_alive",
      "story_priority": "HIGH",
...
Body:
```
After their most recent game, Jesús Luzardo handed off after five innings with a three-run lead, and the bullpen finished it.
```
What BaseballOS noticed / observations:
```
- The starter set the bullpen up to finish the game.
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 823204,
      "generated_at": "2026-06-30T00:58:25.292746",
      "headline_key": "starter_carried_game",
      "primary_story": "starter_covered_bullpen",
      "secondary_story": null,
      "story_priority": "MEDIUM",
...
Body:
```
After their most recent game, Chris Sale worked 6.0 innings, keeping the bullpen out of the heaviest innings. That creates room for the workload to move beyond the usual pocket.
```
What BaseballOS noticed / observations:
```
(none)
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 824580,
      "generated_at": "2026-06-30T00:58:25.371173",
      "headline_key": "bullpen_overexposed",
      "primary_story": "bullpen_overexposed",
      "secondary_story": null,
      "story_priority": "MEDIUM",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 823037,
      "generated_at": "2026-06-30T00:58:25.472876",
      "headline_key": "starter_carried_game",
      "primary_story": "starter_covered_bullpen",
      "secondary_story": null,
      "story_priority": "MEDIUM",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "LOW",
      "game_pk": 824744,
      "generated_at": "2026-06-30T00:58:25.569942",
      "headline_key": "insufficient_context",
      "primary_story": "insufficient_context",
      "secondary_story": null,
      "story_priority": "LOW",
...
```json
{
  ...
  "supporting_context_values": {
    ...
    "narrative_context": {
      ...
      "game_importance": "MEDIUM",
      "game_pk": 823769,
      "generated_at": "2026-06-30T00:58:25.642713",
      "headline_key": "lost_game_shape",
      "primary_story": "lost_game_shape",
      "secondary_story": null,
      "story_priority": "CRITICAL",

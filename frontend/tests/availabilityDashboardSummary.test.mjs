...
test('renders scored pitcher inventory without current availability labeling', () => {
  ...
  assert.equal(view.distributionTitle, 'Read Confidence Mix')
  ...
  assert.ok(htmlIncludes(html, 'Read Confidence Mix'))

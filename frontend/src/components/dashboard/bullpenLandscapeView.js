...
export function getLandscapeView(landscape) {
  ...
  return {
    ...
    columns: [
      { key: 'constrained', title: 'Most Stretched', subtitle: 'Fewest clean late-inning options', metric: 'restricted',
        suffix: 'needing rest or unavailable', tone: COLUMN_TONE.constrained, entries: mapEntries(landscape.constrained_bullpens) },
      { key: 'available', title: 'Most Available', subtitle: 'Most room to maneuver', metric: 'available',
        suffix: 'rested and available', tone: COLUMN_TONE.available, entries: mapEntries(landscape.available_bullpens) },
      { key: 'monitoring', title: 'On Watch', subtitle: 'Recent workload watch groups', metric: 'monitor',

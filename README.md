...
- [V4 Phase 25 frontend explanation evidence capture and reassessment](docs/V4_PHASE_25_FRONTEND_EXPLANATION_EVIDENCE_CAPTURE_AND_REASSESSMENT.md)
  - source/test evidence reassessment for certified frontend explanation
    ...
    controlled rollout review still required, and production-review readiness
    deferred.
- [V4 Phase 24 frontend explanation controlled rollout observation review](docs/V4_PHASE_24_FRONTEND_EXPLANATION_CONTROLLED_ROLLOUT_OBSERVATION_REVIEW.md)
  - controlled rollout observation review for certified frontend explanation
    surfaces, with PASS/PARTIAL findings, no critical governance regression,
    incomplete retained observation evidence, and production-review readiness
    deferred.

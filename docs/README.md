...
As of August 24, 2026, with audited `origin/main` at `4a39802c`:
...
- **TODAY-01 Daily Edition lead integration is the single active objective.** It consumes the existing governed Today lead owner inside the dated public edition with a receipt or honest quiet state and direct Team Board handoff; it adds no new semantic engine, prediction, ranking, or publication authority.

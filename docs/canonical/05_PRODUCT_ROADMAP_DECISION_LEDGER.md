...
| TB-05 — Roles & Deployment | PARTIAL | Current role distribution and descriptive 14-day deployment profiles are integrated and tested. The September 21 TB-05 decision separately authorizes publication-bound factual entry, score, and recorded-LI context without unlocking internal evidence rules. | TB-05 frontend adoption is pending; named-arm role movement has no public materiality rule. |
...
| BE-GAP-06 — Roles & deployment | PARTIALLY CLOSED | Current roles and descriptive deployment profile remain public. The September 21 TB-05 decision governs a separate publication-bound factual entry/score/recorded-LI projection; internal entry rules and save/hold leverage fallback remain unpromoted. Named-arm movement remains unavailable. |

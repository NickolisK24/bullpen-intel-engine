...
| 6 | Phase 0E - Bullpen Read Quality Model | In progress | Read contract and registry landed; reliever and team daily reads are now underway as internal-only composed-read paths with public surfacing still blocked by legal/source review and a later surface phase. |

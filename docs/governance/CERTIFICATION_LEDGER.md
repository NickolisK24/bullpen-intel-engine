...
| V5 Bullpen Intelligence Surface | Phase 3 architecture definition approved | Planning only; implementation and rollout not approved | [V5 Phase 1 capability definition](../V5_PHASE_1_BULLPEN_INTELLIGENCE_SURFACE_CAPABILITY_DEFINITION.md), [V5 Phase 2 observation taxonomy](../V5_PHASE_2_BULLPEN_INTELLIGENCE_SURFACE_OBSERVATION_TAXONOMY.md), [V5 Phase 3 architecture definition](../V5_PHASE_3_BULLPEN_INTELLIGENCE_SURFACE_ARCHITECTURE_DEFINITION.md) |

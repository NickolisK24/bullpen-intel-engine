...
PLAYER_TRANSACTION_CORRECTION_POLICY = register_correction_policy(SourceCorrectionPolicy(
    ...
    fields=(
        ...
        CorrectionFieldPolicy('participant_role', update_after_final=True),
        CorrectionFieldPolicy('participant_role_authority', update_after_final=True),
        CorrectionFieldPolicy('participant_position_code', update_after_final=True),
        CorrectionFieldPolicy('participant_position_abbreviation', update_after_final=True),
        CorrectionFieldPolicy('participant_position_type', update_after_final=True),
        CorrectionFieldPolicy('transaction_subtype', update_after_final=True),
        CorrectionFieldPolicy('transaction_materiality', update_after_final=True),
        CorrectionFieldPolicy('subtype_status', update_after_final=True),
        CorrectionFieldPolicy('subtype_authority', update_after_final=True),
        CorrectionFieldPolicy('subtype_reason_code', update_after_final=True),
        CorrectionFieldPolicy('subtype_evidence', update_after_final=True),
        CorrectionFieldPolicy('source', update_after_final=True),

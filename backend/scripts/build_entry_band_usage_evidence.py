...
def _parse_args(argv=None):
    parser = argparse.ArgumentParser(
        description='Build internal Phase 0D entry-context band and usage-observation evidence for one product date.'
    )
    parser.add_argument(
        '--date',
        required=True,
...
def main(argv=None):
    ...
    from app import app
    from services.entry_band_usage_evidence import build_entry_band_usage_evidence

...
def _parse_args(argv=None):
    parser = argparse.ArgumentParser(
        description='Build internal Phase 0D team relief contributor composition evidence for one product date.'
    )
    parser.add_argument(
        '--date',
        required=True,
...
def main(argv=None):
    ...
    from app import app
    from services.team_relief_composition_evidence import build_team_relief_composition_evidence

...
def _parse_args(argv=None):
    parser = argparse.ArgumentParser(
        description='Build internal Phase 0D workload recovery evidence for one product date.'
    )
    parser.add_argument(
        '--date',
        required=True,
...
def main(argv=None):
    ...
    from app import app
    from services.workload_recovery_evidence import build_workload_recovery_evidence

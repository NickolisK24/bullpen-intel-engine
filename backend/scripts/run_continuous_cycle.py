...
def _compact_cycle_payload(payload):
    compact = {
        ...
        'duplicate_observations': payload.get('duplicate_observations') or 0,
        'stale_observations': payload.get('stale_observations') or 0,
        'superseded_observations': payload.get('superseded_observations') or 0,
        'safe_rejections': payload.get('safe_rejections') or 0,
        'warning_observations': payload.get('warning_observations') or 0,
        'blocking_ambiguities': payload.get('blocking_ambiguities') or 0,

...
from services.what_changed_since_yesterday_review import (  # noqa: E402
...
DEFAULT_OUTPUT = REPO_ROOT / 'artifacts' / 'what_changed_since_yesterday_review.json'


def parse_args():
    parser = argparse.ArgumentParser(
        description='Export an internal What Changed Since Yesterday V1 review.'
    )
    parser.add_argument(
        '--output',
...
def print_summary(report, output_path):
    ...
    print(f'What Changed Since Yesterday review written to {output_path}')
...
def main():
    ...
    with flask_app.app_context():
        ...
        report = build_what_changed_since_yesterday_review(
            current_payload,
            prior_payload,

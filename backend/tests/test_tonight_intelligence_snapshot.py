...
def test_snapshot_version_invalidates_pre_rest_status_payloads():
    assert TONIGHT_SNAPSHOT_VERSION == 'tonight_v5'


def test_default_reader_does_not_accept_an_older_v4_payload(app):
    with app.app_context():
        ...
        assert read_snapshot(REF, version='tonight_v4')['status'] == 'empty'
